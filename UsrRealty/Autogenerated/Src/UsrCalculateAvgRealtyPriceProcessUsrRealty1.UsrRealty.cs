namespace Terrasoft.Core.Process
{
	...
	#region Class: UsrCalculateAvgRealtyPriceProcessUsrRealty1MethodsWrapper

	/// <exclude/>
	public class UsrCalculateAvgRealtyPriceProcessUsrRealty1MethodsWrapper : ProcessModel
	{

		public UsrCalculateAvgRealtyPriceProcessUsrRealty1MethodsWrapper(Process process)
			: base(process) {
